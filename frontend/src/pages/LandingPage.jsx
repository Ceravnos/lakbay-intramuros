...
import { MapPin, Plus, X, Navigation, LogIn, ChevronRight, Trash2, Save, Sparkles, Filter, ChevronDown, Map } from 'lucide-react';
...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-stone-50">
            {/* Header/Navbar */}
            <header className="bg-white/95 backdrop-blur-sm border-b border-stone-200 sticky top-0 z-30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
                    <Link to="/" className="flex items-center gap-2">
                        <MapPin className="w-6 h-6 text-terracotta-600" />
                        <span className="text-lg sm:text-xl font-serif font-semibold text-stone-800">
                            Lakbay Intramuros
                        </span>
                    </Link>
                    <div className="flex items-center gap-2 sm:gap-3">
                        <button
                            onClick={scrollToMap}
                            className="hidden sm:flex items-center gap-2 px-3 py-2 text-sm font-medium text-stone-600 hover:text-stone-900 hover:bg-stone-100 rounded-lg transition-colors"
                        >
                        ...
                        {isAuthenticated ? (
                            <Link
                                to="/dashboard"
                                className="flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 bg-stone-800 hover:bg-stone-900 text-white text-sm font-medium rounded-lg transition-colors"
                            >
                            ...
                            <>
                                <Link
                                    to="/login"
                                    className="px-3 sm:px-4 py-2 text-sm font-medium text-stone-700 hover:text-stone-900 transition-colors"
                                >
                                    Sign in
                                </Link>
                                <Link
                                    to="/signup"
                                    className="px-3 sm:px-4 py-2 bg-terracotta-600 hover:bg-terracotta-700 text-white text-sm font-medium rounded-lg transition-colors"
                                >
                                    Sign up
                                </Link>
                            </>
                                ...
                                <div className="p-3 sm:p-4 border-t border-stone-200 bg-gradient-to-r from-terracotta-50 to-sand-50">
                                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center gap-2 px-4 sm:px-6 py-3 bg-gradient-to-r from-terracotta-600 to-terracotta-500 hover:from-terracotta-700 hover:to-terracotta-600 text-white font-semibold rounded-xl transition-all shadow-md hover:shadow-lg text-sm sm:text-base"
                                        >
